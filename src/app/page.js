            ...
            <div className="flex flex-col justify-center items-center gap-6 w-full max-w-md mx-auto">
              ...
              <div className="flex flex-col gap-4 w-full">
                <button
                  ...
                  className="flex gap-3 justify-center items-center bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 py-3 px-5 rounded-full transition duration-150 ease-in-out"
                >
                ...
                <button
                  onClick={signIn}
                  className="flex gap-3 justify-center items-center bg-blue-700 text-white hover:bg-black-800 focus:outline-none focus:ring-2 focus:ring-black-700 focus:ring-opacity-50 py-3 px-5 rounded-full transition duration-150 ease-in-out"
                >
                  <span className="text-lg font-medium">
                    Sign In
                  </span>
